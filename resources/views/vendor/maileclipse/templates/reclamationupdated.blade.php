...
<head>
  ...
  <title>Traitement réclamation {{$reclamation->code_reclamation}}</title>
  <style type="text/css">
...
<tbody>
<tr>
<td style="border-bottom: 2px solid #000;" width="70%">&nbsp;</td>
</tr>
<tr>
<td valign="top" bgcolor="#dc3545"><!-- [if gte mso 9]>
...
<tbody>
<tr>
<td style="vertical-align: middle; padding-right: 15px; padding-left: 15px; text-align: left;" valign="middle" height="100">
<table width="70%" cellspacing="0" cellpadding="0">
<tbody>
<tr>
<td>
<h5 style="margin-top: 20px;"><font color="#ffffff">Bonjour,</font></h5>
<h5><font color="#ffffff">La r&eacute;clamation : {{$reclamation->code_reclamation}} vient d'&ecirc;tre trait&eacute;e !</font></h5>
</td>
</tr>
</tbody>
</table>
...
<td style="background-color: #dc3545; color: #ffffff; padding: 5px; width: 119px; height: 19px;">Date de traitement</td>
<td style="background-color: #dc3545; color: #ffffff; padding: 5px; width: 31px; height: 19px;">&nbsp;</td>
</tr>
<tr style="height: 19px;">
<td style="background-color: #000; color:#fff; padding: 8px; border-top: 3px solid #ffffff; width: 113px; height: 19px; color:#fff">@date($reclamation->date_traitement_reclamation)</td>
<td style="background-color: #000; color:#fff; padding: 8px; border-top: 3px solid #ffffff; width: 25px; height: 19px;">&nbsp;</td>
</tr>
</tbody>
</table>
</td>
...
<tbody>
<tr>
<td class="mobile-padding" style="text-align: left;"><br />&nbsp;Pour avoir plus d'information sur cette r&eacute;clamation cliquer sur le lien suivant :&nbsp; <a href="{{route('reclamations.edit', $reclamation)}}" style="color:#dc3545">voir r&eacute;clamation</a>. <br /><br />Cordialement,<br /><br /></td>
</tr>
</tbody>
</table>
</td>
...
<tr>
<td style="background-color: #dc3545;"><center>
<table class="w320" width="500" cellspacing="0" cellpadding="0">
<tbody>
<tr>
<td>&nbsp;</td>
