...
<head>
  ...
  <title>Assignation de réclamation : {{$reclamation->code_reclamation}}</title>
  <style type="text/css">
...
<tr>
<td>
<h4 style="margin-top: 20px;"><font color="#ffffff">Bonjour,</font></h4>
<h5 style="color:#fff">{{$assignateur}} vous a assigné la réclamation : {{$reclamation->code_reclamation}}</h5>
</td>
</tr>
</tbody>
</table>
...
<td style="text-align: right; vertical-align: top;"><span class="important-font"> Nom du CCL<br /></span> <p>{{$reclamation->user->name}}</p></td>
</tr>
</tbody>
</table>
</td>
...
<td style="background-color: #dc3545; color: #ffffff; padding: 5px; width: 163px; height: 19px;">Date r&eacute;ception SGBS</td>
...
<td style="background-color: #000000; font-size: 12px; color: #ffffff; padding: 8px; border-top: 3px solid #ffffff; width: 0px; height: 19px;">&nbsp;</td>
</tr>
</tbody>
</table>
</td>
